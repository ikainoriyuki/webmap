...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // 微地形表現図
  微地形表現図: L.tileLayer(
    'https://forestgeo.info/opendata/14_kanagawa/rrim_2022/{z}/{x}/{y}.webp',
    {
      minZoom: 13,
      maxNativeZoom: 18,
      maxZoom: 20,
  ...
  // レーザー林相図
  レーザー林相図: L.tileLayer(
    'https://forestgeo.info/opendata/14_kanagawa/ls_standtype_2020/{z}/{x}/{y}.webp',
    {
      minZoom: 13,
      maxNativeZoom: 18,
      maxZoom: 20,
